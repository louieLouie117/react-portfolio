...
function Goals(props) {
  ...
  const [specializations, Specializations] = useState(true);

  const specializationsHandler =(e)=>{
  ...
  return (
    <div>
            ...
            <ul  style={ { height: specializations ? "205px" : "auto" }} >  
                
                    <li>
                    <h2>Design to code.</h2>
                    <p>HTML and CSS have become part of my intuition, and I can take any design and code it no matter how simple or complex the design is. I love turning design into code since it allows me to use both creativity and logic to develop any UI need.</p>
                ...
                if (window.innerWidth < "550") {
                  return(
                    <button  onClick={ (e) => specializationsHandler(e)}>see all</button>
                    )}
                    })()}
